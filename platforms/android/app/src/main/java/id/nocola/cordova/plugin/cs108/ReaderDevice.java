...
public class ReaderDevice implements Comparable<ReaderDevice> {
    ...
    private int codeSensor = INVALID_CODESENSOR, codeRssi = INVALID_CODERSSI, sensorData = INVALID_SENSORDATA;
    private float codeTempC = INVALID_CODETEMPC;
    ...
    public void setCcompass(String compass) {
